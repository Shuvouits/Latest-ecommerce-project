                            ...
                            <div class="card-body">
                                <form method="post" action="/admin/product/add_product" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="product_title" class="form-control" id="product" placeholder="Product Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select class="form-control select2" name='product_category' id='product_category' style="width: 100%;" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select class="form-control select2" name='product_subcategory' id='product_subcategory' style="width: 100%;" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="pp" class="col-sm-3 col-form-label" style="font-size: 13px;"><strong>Regular Price</strong></label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="regular_price" id="pp" placeholder="Product Price" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="discount_price" id="dp" placeholder="Discount Price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="stock_quantity" id="sq" placeholder="Stock Quantity" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select class="form-control select2" name='product_brand' id='pb' style="width: 100%;" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select class="form-control select2" name='product_season' id='ps' style="width: 100%;">
                                                <option selected='selected' disabled='disabled'>--Select Seasons--</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="5" name="product_description" id="pd" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="meta_keywords" id="mk" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="video_url" id="vu" placeholder="Enter Video Url">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t1" name="title1" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description1" id="td1" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t2" name="title2" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description2" id="td1" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t3" name="title3" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description3" id="td3" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t1" name="title4" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description4" id="td1" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t1" name="title5" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description5" id="td5" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t6" name="title6" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description6" id="td6" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t7" name="title7" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description7" id="td7" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t8" name="title8" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description8" id="td8" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t1" name="title9" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description9" id="td9" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="t10" name="title10" placeholder="Enter Specification Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row collapse" id="demo">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="2" name="description10" id="td1" placeholder="Enter Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="file" id="pre" class="" name='image' onchange="readURL(this);" required>
