            ...
            <div class="bodywrapper__inner">
                ...
                <div class="row align-items-center mb-30 justify-content-between">
                    <div class="col-lg-6 col-sm-6">
                        <h6 class="page-title">Banned Customers</h6>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row justify-content-end">
                                    <div class="col-xl-4 col-lg-6 mb-3">
                                        <form action="https://script.viserlab.com/visermart/admin/customers/banned/search" method="GET" class="form-inline float-sm-right bg--white">
                                ...
                                <div class="table-responsive--md  table-responsive">
                                    <table class="table table--light style--two">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-muted text-center" colspan="100%">No banned customer found</td>
                                            </tr>
