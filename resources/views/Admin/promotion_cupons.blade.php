            ...
            <div class="bodywrapper__inner">
                ...
                <div class="row align-items-center mb-30 justify-content-between">
                    <div class="col-lg-6 col-sm-6">
                        <h6 class="page-title">All Coupons</h6>
                    </div>
                    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3">
                        <a href="https://script.viserlab.com/visermart/admin/promotion/coupon/create" class="btn btn-sm btn--success box--shadow1 text--small"> <i class="las la-plus"></i> Add New</a>
                                        ...
                                        <tbody class="list">
                                            <tr>
                                                ...
                                                <td data-label="Status">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="change_status" name="top" checked data-id=1>
                                                        <span class="slider round"></span>
                                                    </label>

                                                </td>
                                                <td data-label="Expire Date" class="">
                                                    31 May, 2021
                                                </td>
                                                <td data-label="Action">
                                                    <a href="https://script.viserlab.com/visermart/admin/promotion/coupon/edit/1" data-toggle="tooltip" data-placement="top" title="Edit" class="icon-btn edit-btn">
                                                        <i class="la la-pencil"></i>
                                                    </a>

                                                    <button type="button" data-toggle="tooltip" data-placement="top" title="Delete" class="icon-btn btn--danger delete-btn ml-1" data-type="delete" data-id='1'>
