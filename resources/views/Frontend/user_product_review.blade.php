...
<head>
    <title>Viser - Review Products</title>
                ...
                <div class="col-xl-9">
                    <table class="regular-table section-bg">
                        ...
                        <tbody>
                            ...
                            @if($all_cart_information_count !=0)
                            @foreach($all_cart_information as $item)
                            <tr>
                                <td>{{$item->product_title}}</td>
                                <td><img src="{{asset('images/'.$item->product_image)}}" class="img-thumbnail" style="width:60px; height:60px"></td>
                                <td>{{$item->product_price}}</td>
                                <td>{{$item->product_quantity}}</td>
                                <td>

                                    <form method="post" action="/product_review_rating">
                                        {{@csrf_field()}}
                                        <div class="row">
                                           <div class="col-md-8">
                                           <?php $session_user = session()->get('user_name'); ?>
                                        <input type="hidden" name="product_id" value="{{$item->product_id}}">
                                        <input type="hidden" name="user_name" value="{{$session_user}}">
                                        <div class="form-group">

                                            <select class="form-control" id="sel1" name='review' required>
                            ...
                            <tr>
                                <td colspan="100%">
                                    You didn&#039;t receive any of our product yet
                                </td>
                            </tr>
                            @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="add-review">
                        <form action="https://script.viserlab.com/visermart/user/product_review/add" method="POST" class="review-form rating row">
                            <input type="hidden" name="_token" value="sE3eS7cMD58t3s9kNbGCBhCYVIsGQ6dlCMfOTlK2"> <input type="hidden" name="pid" value="">
                            <div class="review-form-group mb-20 col-md-6 d-flex flex-wrap">
                                <label class="review-label mb-0 mr-3">Your Rating :</label>
                            ...
                            <div class="review-form-group mb-20 col-12 d-flex flex-wrap">
                                <label class="review-label" for="review-comments">Say Something about This Product</label>
                                <textarea name="review" class="review-input rounded--5 border--1" id="review-comments"></textarea>
                            </div>
                            <div class="review-form-group mb-20 col-12 d-flex flex-wrap">
                                <button type="submit" class="submit-button rounded--5 btn--sm ml-auto">Submit Review</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#a6d2c3d5d2e6d5cfd2c388c5c9cb"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="037766707743706a77662d606c6e">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
