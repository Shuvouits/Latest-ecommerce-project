                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group price-filter">
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="1000">
                                    <label for="brand-1">1-1000</label>
                                </div>

                                <div class="widget-check-group price-filter">
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="2000">
                                    <label for="brand-1">1000-2000</label>
                                </div>

                                <div class="widget-check-group price-filter">
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="3000">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group brand-filter">
                                    <input type="checkbox" name="id" class="common_selector brand hellow" value="{{$item->id}}">
                                    <label for="brand-1">{{$item->brand_name}}</label>
                                </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group category-filter ">
                                    <input type="checkbox" name="category" class="common_selector category hellow" value="{{$item->id}}">
                    ...
                    <div class="position-relative">
                        ...
                        <div class="page-main-content">
                            ...
                            <div class="row mb-30-none page-main-content " id="grid-view">
                                ...
                                <div class="col-lg-4 col-sm-6 grid-control mb-30 shuvo">
                                        ...
                                        <div class="product-item-2-inner wish-buttons-in">
                                            <div class="product-thumb">
                                                ...
                                                <a href="/product/details/{{$item->product_title}}">
                                                    <img src="{{asset('images/'.$item->image)}}" height="350px" width="400px" alt="flash">
                                                </a>
                                            </div>
                            ...
                            <div class="row mb-30-none page-main-content pric" id="grid-view" style="margin-top:30px">
