                    ...
                    <aside class="category-sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group price-filter">
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="3000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/4000';">
                                            ...
                                            <div class="product-thumb">
                                                <ul class="wish-react">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="/product/compare/{{$item->id}}" title="Compare" class="add-to-compare " data-id="42"><i class="las la-sync-alt"></i></a>
                                                    </li>
                                                </ul>
                                                <a href="https://script.viserlab.com/visermart/product/detail/42/fimi-x8-mini-camera-drone-250g-class-drones-8km-4k-professional-mini-drone-quadcopter-with-camera-gps-remote-control-helicopter">
