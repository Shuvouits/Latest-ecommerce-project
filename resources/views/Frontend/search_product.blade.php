    ...
    <div class="category-section padding-bottom padding-top">
        <div class="container">
            ...
            <div class="alert cl-title alert--base" role="alert">
                ...
                @if($search_subcat_count != '')
                Search Result for <strong class="text--secondary">""</strong> : Total {{$search_subcat_count}} Products Found </div>
            @else
            Search Result for <strong class="text--secondary">""</strong> : Total {{$search_cat_count}} Products Found
        </div>
        @endif
                        ...
                        <div class="product-item-2 m-0">
                            <div class="product-item-2-inner wish-buttons-in">
                                <div class="product-thumb">
                                    ...
                                    <a href="">
                                        <img src="{{asset('images/'.$item->image)}}" class="img-thumbnail" style="width:400px; height:350px" alt="flash">
                                    </a>
                                </div>
                                <div class="product-content">
                                    ...
                                    <div class="product-after-content">
                                        <button data-toggle="modal" data-target="#modal{{$item->id}}" class="cmn-btn btn-sm quick-view-btn">
                                            View </button>
                                        <div class="price">
                                            {{$item->regular_price}}
                                        </div>
                    ...
                    <ul class="pagination">
                        <li>
                            <span class="style">
                                ...
                                {{ $search_value->links('pagination::bootstrap-4') }}
                            </span>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#4f3b2a3c3b0f3c263b2a612c2022"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="057160767145766c71602b666a68">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
