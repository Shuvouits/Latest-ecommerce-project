...
<body>
    ...
    <div class="account-section padding-bottom padding-top">
        <div class="contact-thumb d-none d-lg-block">
            <img src="https://script.viserlab.com/visermart/assets/images/frontend/login_page/5fec5fd64ad681609326550.png" alt="login-bg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <form method="POST" action="/cart/login_post" class="contact-form mb-30-none">
                        {{@csrf_field()}}
                        <div class="contact-group">
                            <label for="username">Username</label>
                            <input id="username" type="text" name="username" placeholder="Enter Your Username" value="">
                        </div>
                        ...
                        <div class="contact-group">
                            <button type="submit" id="recaptcha" class="custom-button m-0 ml-auto">Login</button>
                        </div>
                        ...
                        <div class="contact-group">
                            <div class="w-100">
                                <div class="m--10 d-flex flex-wrap align-items-center justify-content-between">
                                    <span>Don't have an account? <a href="/cart/register">Create An Account</a></span>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#bacedfc9cefac9d3cedf94d9d5d7"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="85f1e0f6f1c5f6ecf1e0abe6eae8">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
