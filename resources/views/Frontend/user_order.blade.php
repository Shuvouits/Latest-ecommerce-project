               ...
               @include('Frontend.dashboard_left_profile')
                <div class="col-xl-9">
                    <table class="payment-table section-bg">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-muted text-center" colspan="100%">No order yet</td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#a4d0c1d7d0e4d7cdd0c18ac7cbc9"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="364253454276455f42531855595b">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
