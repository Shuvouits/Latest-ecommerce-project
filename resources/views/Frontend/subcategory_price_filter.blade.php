...
<body>
    ...
    <div class="hero-section section-bg py-4">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>Products by SubCategory - {{$subcategory_name}} </li>
                @if($value !='')
                <li> / Price - {{$value}}</li>
                @endif
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value=='1000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="1000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/1000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="1000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/1000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value == '2000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="2000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/2000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="2000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/2000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value=='3000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="3000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/3000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="3000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/3000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value == '4000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="4000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/4000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="4000" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/price/4000';">
                                    @endif
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group brand-filter">
                                    <input type="checkbox" checked value="" name="brand" id="brand-4" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/filter/{{$item->brand_name}}';">
                                    <label for="brand-4">{{$item->brand_name}}</label>
                                </div>
                                @else
                                <div class="widget-check-group brand-filter">
                                    <input type="checkbox" value="" name="brand" id="brand-4" onClick="Javascript:window.location.href = '/product/subcategory/{{$subcategory_name}}/filter/{{$item->brand_name}}';">
                                    <label for="brand-4">{{$item->brand_name}}</label>
                                </div>
                                @endif
    ...
    <script>
        $('.hellow').on('change', function() {
            $('.hellow').not(this).prop('checked', false);
        });
    </script>
