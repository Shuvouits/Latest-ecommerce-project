                    ...
                    <div class="row justify-content-center mb-30-none">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="dashboard-item">
                                <a href="/user/payment/history" class="d-block">
                                    <span class="dashboard-icon">
                                        <i class="las la-wallet"></i>
                                    </span>
                                    <div class="cont">
                                        <div class="dashboard-header">
                                            <h2 class="title">{{$all_order_count}}</h2>
                                            <h2 class="title"></h2>
                                        </div>
                                        All Orders
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="dashboard-item">
                                <a href="/user/payment/history" class="d-block">
                                    ...
                                    <div class="cont">
                                        <div class="dashboard-header">
                                            <h2 class="title">{{$processing_order_count}}</h2>
                                            <h2 class="title"></h2>
                                        </div>
                                        Processing Orders
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="dashboard-item">
                                <a href="/user/payment/history">
                                    ...
                                    <div class="cont">
                                        <div class="dashboard-header">
                                            <h2 class="title">{{$faild_order_count}}</h2>
                                            <h2 class="title"></h2>
                                        </div>
                                        Faild Orders
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="dashboard-item">
                                <a href="/user/payment/history">
                                    ...
                                    <div class="cont">
                                        <div class="dashboard-header">
                                            <h2 class="title">{{$pending_order_count}}</h2>
                                            <h2 class="title"></h2>
                                        </div>
                                        Pending Orders
                                    </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#3f4b5a4c4b7f4c564b5a115c5052"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="85f1e0f6f1c5f6ecf1e0abe6eae8">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
