...
<body>
    ...
    <div class="account-section padding-bottom padding-top">
        <div class="contact-thumb d-none d-lg-block">
            <img src="https://script.viserlab.com/visermart/assets/images/frontend/forgot_password_page/5ff4c6a66059e1609877158.png" alt="login-bg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <div class="section-header left-style">
                        ...
                        <p>Submit the Phone to reset your password.</p>
                    </div>
                    ...
                    <form method="POST" action="/cart/password/reset" class="contact-form mb-30-none">
                        ...
                        <div class="contact-group">
                            ...
                            <input id="email" type="text" name="mobile_number" value="" placeholder="Enter The Correct Mobile Number" required autocomplete="text" autofocus>
