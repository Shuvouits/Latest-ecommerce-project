...
<body>
    ...
    <div class="dashboard-menu before-login-menu d-flex flex-wrap justify-content-center flex-column">
        ...
        <div class="login-wrapper py-5 px-4">
            ...
            <form method="POST" action="https://script.viserlab.com/visermart/login" class="sign-in-form">
                <input type="hidden" name="_token" value="Bpsxhomqm9MVsdszX7qxhdpsRn755U2x76lufuXQ">
                ...
                <div class="form-group">
                    ...
                    <div class='login captcha'><span style="    float:left;     -webkit-transform: rotate(32deg);">7</span><span style="    float:left;     -webkit-transform: rotate(-3deg);">3</span><span style="    float:left;     -webkit-transform: rotate(7deg);">9</span><span style="    float:left;     -webkit-transform: rotate(-2deg);">5</span><span style="    float:left;     -webkit-transform: rotate(-25deg);">6</span><span style="    float:left;     -webkit-transform: rotate(2deg);">8</span></div><input type="hidden" name="captcha_secret" value="cc2f6e9def168774797376c0fa6db1e900675b440082a1bdc8384f83b8c2c171">
                </div>
    ...
    <div class="account-section padding-bottom padding-top">
        ...
        <div class="contact-thumb rev-side d-none d-lg-block">
            <img src="https://script.viserlab.com/visermart/assets/images/frontend/register_page/5fec6155771601609326933.png" alt="register-bg">
        </div>
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-5">
                    <div class="section-header left-style">
                        ...
                        <p>Welcome to Visermart</p>
                    </div>
                    <form action="/cart/register_post" method="POST" class="contact-form mb-30-none">
                        {{@csrf_field()}}
                        ...
                        <div class="contact-group">
                            <div class=" w-100 ">
                                <div class="m--10 d-flex flex-wrap align-items-center justify-content-between">
                                    <span class="account-alt">Already have an account? <a href="/cart/login">Login</a></span>
                                    <button type="submit" id="recaptcha" class="custom-button">Sign Up</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#5a2e3f292e1a29332e3f74393537"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="601405131420130914054e030f0d">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
