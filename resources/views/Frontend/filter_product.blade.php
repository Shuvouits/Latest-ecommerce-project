...
<head>
    <title>Viser - Products by Brand - {{$brand_name}}</title>
    ...
    <div class="hero-section section-bg py-4">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="https://script.viserlab.com/visermart/brands">Brands</a></li>

                <li>Products by Brand - {{$brand_name}} </li>
                @if($value !='')
                <li style="margin-left:10px"> / Price - {{$value}}</li>
                @endif

                @if($category_name !='')
                <li style="margin-left:10px"> / Category - {{$category_name}}</li>
                @endif
                    ...
                    <aside class="category-sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="widget-check-group price-filter">
                                    @if($value=='1000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="1000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/1000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="1000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/1000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value=='2000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="2000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/2000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="2000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/2000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value=='3000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="3000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/3000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="3000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/3000';">
                                    @endif
                                ...
                                <div class="widget-check-group price-filter">
                                    @if($value=='4000')
                                    <input type="checkbox" checked name="price" class="common_selector price hellow" value="4000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/4000';">
                                    @else
                                    <input type="checkbox" name="price" class="common_selector price hellow" value="4000" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/price/4000';">
                                    @endif
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-check-group category-filter ">

                                    @if($category_name == $item->category_name)
                                    <input type="checkbox" checked name="category" class="common_selector category hellow" value="{{$item->id}}" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/category/{{$item->category_name}}';">
                                    @else
                                    <input type="checkbox" name="category" class="common_selector category hellow" value="{{$item->id}}" onClick="Javascript:window.location.href = '/product/filter/{{$brand_name}}/category/{{$item->category_name}}';">
                                    @endif
                                    <label for="category">{{$item->category_name}}</label>
                                </div>
                    ...
                    <div class="position-relative">
                        ...
                        <div class="page-main-content">
                            <div class="row mb-30-none page-main-content" id="grid-view">
                                    ...
                                    <div class="product-item-2 m-0">
                                        <div class="product-item-2-inner wish-buttons-in">
                                            <div class="product-thumb">
                                                <ul class="wish-react">
                                                    <li>
                                                        <a href="/product/wishlist/{{$item->id}}" title="Add To Wishlist" class="add-to-wish-list " data-id="42"><i class="lar la-heart"></i></a>
                                                    </li>
                                                    <li>

                                                        <a href="/product/brand/{{$item->id}}" title="Compare" class="add-to-compare " data-id="42"><i class="las la-sync-alt"></i></a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="product-content">
                                                <div class="product-before-content">
                                                    <h6 class="title">
                                                        <a href="https://script.viserlab.com/visermart/product/detail/42/fimi-x8-mini-camera-drone-250g-class-drones-8km-4k-professional-mini-drone-quadcopter-with-camera-gps-remote-control-helicopter">FIMI X8 Mini Camera Drone 250g-class drones 8km 4k professional mini drone Quadcopter with camera gps remote control helicopter</a>
                                                    </h6>
                                                    ...
                                                    <div class="single_content">
                                                        <p>Small but powerful, with 30 minutes of battery life, the FIMI X8 Mini lets you create the blockbuster of your dreams</p>
                                                    </div>
                                                ...
                                                <div class="product-after-content">
                                                    <button data-product="42" class="cmn-btn btn-sm quick-view-btn" data-toggle='modal' data-target='#product{{$item->id}}'>
                                                        View </button>
                                                    <div class="price">
                                                        {{$item->regular_price}} TK.
                                                    </div>
                                ...
                                @else
                                <h4 style="margin-left: 30px;">No Product Found!</h4>
                                @endif
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-widget widget-link widget-contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/cdn-cgi/l/email-protection#bfcbdacccbffccd6cbda91dcd0d2"><i class="las la-envelope"></i><span class="__cf_email__" data-cfemail="0e7a6b7d7a4e7d677a6b206d6163">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
